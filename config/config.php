...
exit();
    ...
    if (isset($_SESSION["isauth"]) and $_SESSION["isauth"] === true){
        ...
        echo "Здравствуйте, ".$userdata['login']."";
    }
    ...
    if (isset($_POST["token"])){
        ...
        if( $token == $_SESSION["CSRF"]) {
            ...
            if(isset($_POST["login"]) && isset($_POST["pass"])) {
                ...
                $sel = "SELECT * FROM users31 WHERE LOGIN='". $login."'";
                ...
                if(mysqli_num_rows($result) > 0) {
                    ...
                    $result = mysqli_query($link,"INSERT INTO users31 SET LOGIN='".$_POST["login"]."', PASSWORD='".$pass_hash."'");
